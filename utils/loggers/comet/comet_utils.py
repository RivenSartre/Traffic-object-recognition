...
def check_comet_weights(opt):
    """Downloads model pre_weights from Comet and updates the
    pre_weights path to point to saved pre_weights location
    ...
    Returns:
        None/bool: Return True if pre_weights are successfully downloaded
            else return None
    """
    if comet_ml is None:
        return
